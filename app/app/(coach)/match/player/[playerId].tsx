...
/**
 * Match Player Stats Screen (Coach View)
 * Shows individual player performance in a specific match
 * PDF page 15
 */
export default function MatchPlayerStatsScreen() {
  const router = useRouter();
  const { playerId } = useLocalSearchParams();

  // In a real app, fetch player match stats by playerId
